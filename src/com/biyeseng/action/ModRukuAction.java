 ...
 *
 */
public class ModRukuAction extends HttpServlet {	
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)	
		...
		String sql = "update ruku set danhao='"+danhao+"',car='"+car+"',kuname='"+kuname+"',info='"+info+"',appuser='"+appuser+"',date='"+date+"' where id="+id;	
